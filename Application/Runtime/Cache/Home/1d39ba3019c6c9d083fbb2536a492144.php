  ...
  <div class="fullbox" style="border-bottom:1px solid #eee;">
     <div class="centerbox">
       <div class="catagory" style="float:left;">
         <div class="item" style="text-align:left;"><span id="itemall" ng-click="kind = ''">显示全部</span></div>
       </div>
       <div class="catagory" style="float:right;">
         <div class="item"><span id="item1" ng-click="kind = {'kind' : 'cake'}">生日蛋糕</span></div>
         <div class="item"><span id="item2" ng-click="kind = {'kind' : 'desert'}">甜点</span></div>
         <div class="item"><span id="item3" ng-click="kind = {'kind' : 'drink'}">酒水</span></div>
       </div>
     </div>
   </div>
   <div class="fullbox">
     <div class="centerbox">
         <a class="goodpad" ng-repeat="good in goods | filter:kind" ng-href="/cakefox/index.php/Home/Index/{{good.link}}" onmouseenter="$(this).children('.goodms').css('opacity','1');" onmouseleave="$(this).children('.goodms').css('opacity','0');">
