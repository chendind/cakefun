 ...
 <div class="fullbox" ng-init="goodshow='all'" style="min-height:500px;">
   <div class="centerbox">
    ...
    <div class="goodbox" ng-hide="goodshow!='cake'">
     <?php if(is_array($cakes)): $i = 0; $__LIST__ = $cakes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vocake): $mod = ($i % 2 );++$i;?><a class="goodpad"  href="/cakefox/index.php/Home/Index/detail/id/<?php echo ($vocake["good_id"]); ?>" onmouseenter="$(this).children('.goodms').css('opacity','1');" onmouseleave="$(this).children('.goodms').css('opacity','0');">
  ...
  <div class="goodbox" ng-hide="goodshow!='desert'">
     <?php if(is_array($xidian)): $i = 0; $__LIST__ = $xidian;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voxd): $mod = ($i % 2 );++$i;?><a class="goodpad"  href="/cakefox/index.php/Home/Index/detail/id/<?php echo ($voxd["good_id"]); ?>" onmouseenter="$(this).children('.goodms').css('opacity','1');" onmouseleave="$(this).children('.goodms').css('opacity','0');">
  ...
  <div class="goodbox" ng-hide="goodshow!='drink'">
    <?php if(is_array($jiushui)): $i = 0; $__LIST__ = $jiushui;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vojs): $mod = ($i % 2 );++$i;?><a class="goodpad"  href="/cakefox/index.php/Home/Index/detail/id/<?php echo ($vojs["good_id"]); ?>" onmouseenter="$(this).children('.goodms').css('opacity','1');" onmouseleave="$(this).children('.goodms').css('opacity','0');">
...
<?php if(is_array($allgoods)): $i = 0; $__LIST__ = $allgoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voall): $mod = ($i % 2 );++$i;?><a class="goodpad"  href="/cakefox/index.php/Home/Index/detail/id/<?php echo ($voall["good_id"]); ?>" onmouseenter="$(this).children('.goodms').css('opacity','1');" onmouseleave="$(this).children('.goodms').css('opacity','0');">
