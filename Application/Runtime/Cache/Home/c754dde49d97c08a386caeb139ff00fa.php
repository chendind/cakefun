<?php if (!defined('THINK_PATH')) exit();?><div class="cust-choose-bar">
      <nav class="cust-choose">
        ...
        <a href="#/5pounds" class="nav-selected">5磅蛋糕</a>
        <a href="#/selected">精选蛋糕</a>
      </nav>
      </div>
...
<div class="floatleft controll-bar">
  <div class="controll-bar-select-unit">
    ...
    <div class="floatleft controll-bar-select-option" ng-click="position1='-10px -340px'" ng-class="{optSelected:position1=='-10px -340px'}">布丁</div>
    <div class="floatleft controll-bar-select-option" ng-click="position1='-330px -40px'" ng-class="{optSelected:position1=='-330px -40px'}">芝士</div>
    <div class="floatleft controll-bar-select-option" ng-click="position1='-10px -640px'" ng-class="{optSelected:position1=='-10px -640px'}">戚风</div>
  </div>
  <div class="controll-bar-select-unit">
    ...
    <div class="floatleft controll-bar-select-option" data-material="2">方形</div>
    <div class="floatleft controll-bar-select-option" data-material="3">六边形</div>
    <div class="floatleft controll-bar-select-option" data-material="4">星型</div>
  </div>
  <div class="controll-bar-select-unit">
    ...
    <div class="floatleft controll-bar-select-option" data-material="1">奶酪</div>
  </div>
  <div class="controll-bar-select-unit">
    <div class="controll-bar-select-title">裱花样式</div>
    <div class="floatleft controll-bar-select-option" data-material="1">脱脂奶油</div>
    <div class="floatleft controll-bar-select-option" data-material="1">巧克力</div>
    <div class="floatleft controll-bar-select-option" data-material="1">冰淇淋</div>
    <div class="floatleft controll-bar-select-option" data-material="1">蓝莓</div>
  </div>
</div>
</div>
    </div>